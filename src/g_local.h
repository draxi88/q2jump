...
void fire_blaster (edict_t *self, vec3_t start, vec3_t aimdir, int damage, int speed, int effect, qboolean hyperblaster);
...
//ZOID
	...
	// trigger_welcome
	int         welcome_count[11];

	// trigger_announce
	int         announce_count[21];
